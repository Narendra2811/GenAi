...
class Template(BaseModel):
    topic: str = Field(..., description="The product or service being reviewed")
    pros: str = Field(
        ..., description="The advantages or positive aspects of the product or service"
    )
    cons: str = Field(
        ...,
        description="The disadvantages or negative aspects of the product or service",
    )
    rating: float = Field(
        ..., description="The rating of the product or service on a scale of 1 to 5"
    )
